...
const Social = () => (
    <div className="flex transition ease-in duration-150"> 
        <a className="mr-2 transition transform hover:scale-105 hover:-translate-y-1" href="https://www.linkedin.com/in/erichayes8/" target="_blank" rel="noopener noreferrer">
